...
import com.br.igorsily.cursomc.dto.CredenciaisDTO;
...
//		setAuthenticationFailureHandler(new JWTAuthenticationFailureHandler());
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			UsernamePasswordAuthenticationToken authToken = new UsernamePasswordAuthenticationToken(credencial.getEmail(),
					credencial.getSenha(), new ArrayList<>());
